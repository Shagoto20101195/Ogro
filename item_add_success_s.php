...
<head>
    ...
    <title>Ogro - Item Add Successful</title>
</head>
...
<body>
    ...
    <main>
        <div class="middle-section">
            <div>
                <h1 style="text-align: center;">Dear user, your item was added successful into the inventory and unique user ID is: <?php
                    echo($_SESSION['item']['item_no']);
                    //unset($_SESSION['user']);
                ?></h1>
                <h1 style="text-align: center;"><a href="stock_info.php">View Stock</a></h1>
            </div>
         </div>
    </main>
